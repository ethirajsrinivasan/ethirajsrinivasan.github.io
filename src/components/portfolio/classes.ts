...
export const pl = {
  ...
  category: 'inline-flex items-center px-3 py-1 bg-white/15 backdrop-blur-md border border-white/20 text-white rounded-full text-xs font-mono uppercase tracking-[0.16em] mb-4',
  title: 'font-display font-light tracking-tightest text-4xl md:text-5xl lg:text-6xl leading-[1.05] text-white text-balance',
  article: 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8',
  grid: 'grid lg:grid-cols-3 lg:grid-rows-[auto_auto] gap-12',
  content: 'lg:col-span-2 lg:row-start-1',
  aside: 'lg:col-span-1 lg:col-start-3 lg:row-start-1',
  navRow: 'lg:col-span-3 lg:col-start-1 lg:row-start-2',
